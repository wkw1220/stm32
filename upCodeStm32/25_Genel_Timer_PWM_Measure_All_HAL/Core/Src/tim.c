...
double Dri_Tim4_getFrequency(void){
    return 1000000/(__HAL_TIM_GetCompare(&htim4,TIM_CHANNEL_1)+1);
}

double Dri_Tim4_getDutyCycle(void){
    return ((1+__HAL_TIM_GetCompare(&htim4,TIM_CHANNEL_2))*1.0)/(__HAL_TIM_GetCompare(&htim4,TIM_CHANNEL_1)+1);
}
/* USER CODE END 1 */
