...
static uint8_t socketCount = 8;
static uint8_t socketList[8] = {0,1,2,3,4,5,6,7};//八个socket通道，可以支持八个并发
static uint8_t *content_name = "index.html";//用static做成常量放到flash中
/* 响应的网页的内容 */
